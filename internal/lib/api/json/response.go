...
// JSON body for HTTP 503 when the request deadline was exceeded.
...
// context deadline, the response carries ErrorCodeRequestTimeout so that
// upstream dispatch layers can surface a 503 instead of 500.
...
// Reports whether an error originates from a context deadline.
