...
func Test_TimeInForce(t *testing.T) {

	t.Run("TimeInForceFromGRPC()", func(t *testing.T) {

		tests := []struct {
			name     string
			value    v4grpc.TimeInForce
			isValid  bool
			...
			{
				name:     "FOK",
				value:    v4grpc.TimeInForce_FOK,
				isValid:  true,
				expected: TimeInForce_FOK,
			},
			{
				name:     "GTC",
				value:    v4grpc.TimeInForce_GTC,
				isValid:  true,
				expected: TimeInForce_GTC,
			},
			{
				name:     "GTD",
				value:    v4grpc.TimeInForce_GTD,
				isValid:  true,
				expected: TimeInForce_GTD,
			},
			{
				name:     "IOC",
				value:    v4grpc.TimeInForce_IOC,
				isValid:  true,
				expected: TimeInForce_IOC,
			},
		}
		...
		for _, tt := range tests {
			...
			t.Run(name, func(t *testing.T) {
				...
				r, err := TimeInForceFromGRPC(tt.value)
