...
// Special sentinel values for absent, invalid, and never-occurring times.
const (
...
func (ts *Timestamp) UnmarshalJSON(data []byte) (err error) {
	// Avoid float64 coercion by trying integer and string millisecond forms.
...
// Converts signed millisecond values accepted by the public generic wrapper.
...
// Converts unsigned millisecond values accepted by the public generic wrapper.
