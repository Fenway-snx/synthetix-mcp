...
// NextTimeframeBoundary returns the start of the next timeframe period after startTime.
...
// GetParentTimeframe returns the parent timeframe for hierarchical aggregation
// e.g., 5m -> 1m, 1h -> 5m, 1d -> 1h
