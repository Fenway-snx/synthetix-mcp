# lib/runtime/health/types <!-- omit in toc -->

This package contains general purpose **runtime health types** helper functions for use throughout the codebase.
...
* **lib/runtime/health/state_manager**;
