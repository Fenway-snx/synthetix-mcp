...
// (Resting / Filled / Canceled / error) rather than the flat
// status+code+message envelope the gRPC path exposed, so the
...
// from the gRPC era that we keep to avoid breaking the public tool
