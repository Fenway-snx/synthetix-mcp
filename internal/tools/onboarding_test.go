...
// Covers order phase routing, especially ambiguous accepted responses.
...
// Confirms authentication guidance keeps guardrails optional by default.
...
// Confirms broker capability guidance stays consistent.
...
func TestContextCapabilitiesFromFlagsBrokerDisabled(t *testing.T) {
	...
	// Protects the no-signatures-in-chat guidance.
...
// Confirms the server-info broker snapshot matches capability guidance.
