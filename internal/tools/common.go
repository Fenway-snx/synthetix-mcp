...
// Returns a zero output with nil slices and maps initialized.
// This emits [] and {} instead of null for more predictable agent parsing.
// Reflection avoids hand-written constructors for every output struct.
