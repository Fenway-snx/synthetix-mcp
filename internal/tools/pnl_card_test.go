...
// Confirms win/loss closes render with the correct status and arrow.
...
// Confirms missing snapshot or fill price renders an acknowledgement card.
...
// Confirms the portfolio-close card uses net PnL for header status.
...
// Confirms any rejected leg switches the batch card to warning.
...
// Confirms short closes invert price-delta sign correctly.
...
// Guards unit labels across common market separators.
// Fallback label is "contracts".
