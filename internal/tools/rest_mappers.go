...
// market://specs/{symbol}. Field coverage drifts deliberately from
// the legacy gRPC-backed mapper because the REST /v1/info getMarkets
// response is richer (explicit price/quantity exponents and
// increment strings) but omits several gRPC-only fields
