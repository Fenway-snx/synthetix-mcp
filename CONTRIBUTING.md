...
- a guardrail test (auth required? rate limited? side-effect free?)
...
The `internal/lib/` tree is vendored from the Synthetix v4-offchain
monorepo at extraction time. Treat it as a frozen snapshot:
